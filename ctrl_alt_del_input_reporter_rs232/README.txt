Arduino code to read in controller inputs and output them over SoftwareSerial in a packet format to be parsed by the Godot project. Current reported values are:
...
SoftwareSerial is connected to pins 2 (rxPin) and 3 (txPin). TTL to RS232 module is connected to the RS232 to USB cable with a null modem.
